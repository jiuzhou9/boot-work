...
public class JwtTokenUtilB {
     ...
     * claims
     */
    protected static Map<String, Object> claims = new HashMap<>();

    protected static final String CLAIM_USERNAME = "username";
    protected static final String CLAIM_APP_NAME = "appname";
